    ...
    <div className={sectionClass} id={sectionId} data-speakers-id={moduleId}>
      <div className="container">
        <div className="speakers-inner">
          ...
          {fieldValues.bottomContent && (
            <div className="speakers-bottom-content" dangerouslySetInnerHTML={{ __html: fieldValues.bottomContent }} />
          )}
        </div>
      </div>
...
export const fields = (
  <ModuleFields>
    ...
    <RichTextField
      ...
      helpText="Text to display at the bottom of the section"
    />
  </ModuleFields>
);
